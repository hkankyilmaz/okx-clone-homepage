...
function SectionTwo() {
    return (
        <section className='text-white flex flex-col justify-center items-center my-[120px] max-sm:my-[60px] p-5' >
            ...
            <video ty src='https://static.okx.com/cdn/assets/files/2212/882D5049A31E763B.mp4' style={{ viewTransitionName: "visible" }} muted autoPlay loop playsInline className='mt-[80px]'>
                <track kind='caption' />
            </video>
        </section>
    )
